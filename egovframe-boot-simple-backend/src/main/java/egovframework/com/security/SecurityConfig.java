...
/**
 * fileName : SecurityConfig author : crlee date : 2023/06/10 description :
 * =========================================================== DATE AUTHOR NOTE
 * ----------------------------------------------------------- 2023/06/10 crlee
 * 최초 생성
 */
...
public class SecurityConfig {
	...
	private String[] AUTH_GET_WHITELIST = { "/mainPage", // 메인 화면 리스트 조회
			"/board", // 게시판 목록조회
	...
	// 인증 예외 List
	private String[] AUTH_WHITELIST = { "/", "/error", // 에러 페이지
			"/login/**", "/auth/login-jwt", // JWT 로그인
			"/auth/logout", // 로그아웃
			"/file", // 파일 다운로드
			"/etc/**", // 사용자단의 회원약관,회원가입,사용자아이디 중복여부체크 URL허용

			/* 정적 리소스 */
			"/css/**", "/js/**", "/images/**", "/static/**", "/favicon.ico", "/index.html",

			/* swagger */
			"/v3/api-docs/**", "/swagger-resources", "/swagger-resources/**", "/swagger-ui.html", "/swagger-ui/**",
			"/webjars/**", // Swagger UI 정적 리소스

	};
	private static final String[] ORIGINS_WHITELIST = { "http://localhost:3000", };
